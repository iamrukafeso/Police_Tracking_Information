...
public class FingerPrintAuthentication extends AppCompatActivity {
    ...
    private LottieAnimationView  mFingerprintImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSkipBtn = findViewById(R.id.loginInsteadBtn);

        mSkipBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent login = new Intent(FingerPrintAuthentication.this,login.class);
                startActivity(login);
                finish();
            }
        });

        mFingerprintImage.animate().setDuration(5000).setStartDelay(5000);
